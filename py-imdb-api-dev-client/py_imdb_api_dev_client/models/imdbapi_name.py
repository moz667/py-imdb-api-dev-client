...
class ImdbapiName(object):
    ...
    swagger_types = {
        ...
        'height_cm': 'int',
        'birth_name': 'str',
        'birth_date': 'ImdbapiPrecisionDate',
        'birth_location': 'str',
        'death_date': 'ImdbapiPrecisionDate',
        'death_location': 'str',
        'death_reason': 'str',
    ...
    def __init__(self, id=None, display_name=None, alternative_names=None, primary_image=None, primary_professions=None, biography=None, height_cm=None, birth_name=None, birth_date=None, birth_location=None, death_date=None, death_location=None, death_reason=None, meter_ranking=None, _configuration=None):  # noqa: E501
        ...
        if meter_ranking is not None:
            self.meter_ranking = meter_ranking
    ...
    @property
    def height_cm(self):
        """Gets the height_cm of this ImdbapiName.  # noqa: E501

        The height of the person in centimeters.  # noqa: E501

        :return: The height_cm of this ImdbapiName.  # noqa: E501
        :rtype: int
        """
    ...
    def height_cm(self, height_cm):
        """Sets the height_cm of this ImdbapiName.

        The height of the person in centimeters.  # noqa: E501

        :param height_cm: The height_cm of this ImdbapiName.  # noqa: E501
        :type: int
        """
    ...
    @property
    def meter_ranking(self):
        """Gets the meter_ranking of this ImdbapiName.  # noqa: E501

        The IMDb popularity meter ranking for the person, which includes their current rank, change direction, and difference from the previous measurement. This field is optional and may not be present for all names.  # noqa: E501

        :return: The meter_ranking of this ImdbapiName.  # noqa: E501
        :rtype: ImdbapiNameMeterRanking
        """
        return self._meter_ranking

    @meter_ranking.setter
    def meter_ranking(self, meter_ranking):
        """Sets the meter_ranking of this ImdbapiName.

        The IMDb popularity meter ranking for the person, which includes their current rank, change direction, and difference from the previous measurement. This field is optional and may not be present for all names.  # noqa: E501

        :param meter_ranking: The meter_ranking of this ImdbapiName.  # noqa: E501
        :type: ImdbapiNameMeterRanking
        """

        self._meter_ranking = meter_ranking
